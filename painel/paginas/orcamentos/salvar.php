...
if($id == 0){
$pdo->query("INSERT INTO orcamentos SET valor = '$subtotal_venda', data = curDate(), dias_validade = '$dias_validade', usuario = '$usuario', cliente = '$cliente', hora = curTime(), forma_pgto = '$forma_pgto', desconto = '$desconto', tipo_desconto = '$tipo_desconto', subtotal = '$subtotal_venda', tipo = '$tipo', obs = '$obs', status = 'Pendente'");
	...
	$pdo->query("UPDATE orcamentos SET valor = '$subtotal_venda', dias_validade = '$dias_validade', usuario = '$usuario', cliente = '$cliente', forma_pgto = '$forma_pgto', desconto = '$desconto', tipo_desconto = '$tipo_desconto', subtotal = '$subtotal_venda', tipo = '$tipo', obs = '$obs' WHERE id = '$id'");
	$id_orcamento = $id;	
